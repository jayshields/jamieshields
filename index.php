...
<body>
  <a name="home"></a>
		...
		<div class="overlay-menu-inner">
			<nav class="overlay-menu-nav">
				...
				<ul id="nav">
					...
					<li><a href="#contact" class="section-scroll">Contact</a>
					</li>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-sm-12 text-center">
						<p class="copyright font-alt m-b-0">&copy; 2015 Jamie Shields, All Rights Reserved.</p>
					</div>
	...
	<div class="wrapper">
		...
		<!-- HERO -->
		<section id="hero" class="module-hero module-parallax module-full-height bg-dark-60" style="margin-bottom: 70px;" data-background="assets/images/section-5.jpg">
